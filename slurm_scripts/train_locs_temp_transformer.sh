...
#SBATCH --mem=120000M
#SBATCH --output=/home/vkyriacou88/output_gns_locs_temp_results_%A.out
...
--model_path="${SCRATCH}/models/${data}/locs/temporal_transformer" \
--output_path="${SCRATCH}/rollout/${data}/locs/temporal_transformer" \
--nsave_steps=50000 \
--cuda_device_number=0 \
--ntraining_steps=20000000 \
--batch_size=2 \
--model_name="locs_temporal_transformer" \
# --lr_init=0.001 \
# --noise_std=3e-4 
--model_file="latest" \
